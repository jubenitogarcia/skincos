...
import models
from apps.agent_zero_core.python.helpers import runtime, settings, defer
...
def initialize_chats():
    from apps.agent_zero_core.python.helpers import persist_chat
...
def initialize_mcp():
    ...
    async def initialize_mcp_async():
        from apps.agent_zero_core.python.helpers.mcp_handler import initialize_mcp as _initialize_mcp
        return _initialize_mcp(set["mcp_servers"])
    return defer.DeferredTask().start_task(initialize_mcp_async)

def initialize_job_loop():
    from apps.agent_zero_core.python.helpers.job_loop import run_loop
