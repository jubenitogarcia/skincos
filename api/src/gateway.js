...
export function createApiGateway({ inventoryHandler, financeDomainHandler = createFinanceHandler(), resolveActor = resolveFinanceActor, rateLimit = enforceFinanceRateLimit } = {}) {
