...
const DEFAULT_OFFICIAL_MODULE_PATH = path.join(SKINCOS_ROOT, 'backend', 'apps', 'whatsapp', 'official-module')
...
const WHATSAPP_MODULE_PATH = process.env.WHATSAPP_MODULE_PATH ||
  (fsSync.existsSync(DEFAULT_OFFICIAL_MODULE_PATH) ? DEFAULT_OFFICIAL_MODULE_PATH : LEGACY_OFFICIAL_MODULE_PATH)
