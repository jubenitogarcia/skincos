...
Não há workflow GitHub Actions para publicar o CRM API. Neste host, a promoção nativa local é a fonte de verdade; uma segunda via por SSH foi removida para impedir releases concorrentes.
