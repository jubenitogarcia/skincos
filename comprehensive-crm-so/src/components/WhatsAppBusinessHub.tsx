...
import { sendWhatsAppMessage, mapWhatsAppMessageToLead, sendWhatsAppAttachments, detectWhatsAppMediaType } from '@/services/whatsappIntegration'
import { analyzeSentiment } from '@/services/sentiment'
import { sendWhatsAppContact, sendWhatsAppPoll, forwardWhatsAppMessage, pinWhatsAppMessage, unpinWhatsAppMessage, deleteWhatsAppMessage, bulkForwardWhatsAppMessages, bulkDeleteWhatsAppMessages, archiveWhatsAppChat, unarchiveWhatsAppChat, muteWhatsAppChat, unmuteWhatsAppChat, pinWhatsAppChat, unpinWhatsAppChat, markChatSeen, searchWhatsAppMessages } from '@/services/whatsappIntegration'
// import { initiateLocalWhatsApp, getLocalWhatsAppStatus } from '@/services/whatsappLocalGateway'
import { startSessionAuto, getSessionAuto, detectEndpoints, fetchChatsAuto, fetchMessagesAuto, openEventsStreamAuto, fetchAvatarAuto, fetchRecentMediaAuto, fetchChatFlagsAuto, fetchUnreadCountsAuto, globalSearchAuto } from '@/services/whatsappGatewayAdapter'
import { fetchCommonGroups } from '@/services/whatsappIntegration'
