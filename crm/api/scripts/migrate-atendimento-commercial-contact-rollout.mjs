...
if (!databaseUrl || !isStrictLocalMirrorDestination(databaseUrl)) throw new Error('DATABASE_URL deve apontar exclusivamente para o socket local admin de skincos_crm_local.')
