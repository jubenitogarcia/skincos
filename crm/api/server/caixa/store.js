    ...
    return {
        ...
        async overview(query = {}) {
            ...
            const [summaryResult, salesResult, pendingResult, latestResult] = await Promise.all([
                ...
                pool.query(`select i.raw_name,count(*)::int as count from crm_caixa.sale_items i where i.mapping_status='pending' group by i.raw_name order by count desc,i.raw_name limit 100`),
