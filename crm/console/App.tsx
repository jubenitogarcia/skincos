    ...
    const hasModuleAccess = React.useCallback(
	    ...
	    const saveProfile = React.useCallback(async () => {
		    ...
		    const UNLOCKED_MODULE_KEYS = useMemo(
		        () => new Set([DEFAULT_MODULE_KEY, 'insumos', 'conversa', 'atendimento', 'caixa', 'clientes', 'faturamento', 'procedimentos', 'unit-monitor', 'instagram-studio', 'meta-pages-review', 'meta-ads', 'site-tracking', 'escala-profissionais', 'ponto']),
		        [DEFAULT_MODULE_KEY]
		    )
