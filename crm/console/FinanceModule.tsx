...
import { FinanceObligationsPanel } from '@/FinanceObligationsPanel'
import { FinanceRecurrencesPanel } from '@/FinanceRecurrencesPanel'
...
export function FinanceModule() {
  ...
  return <div className="finance-surface space-y-6" data-finance-module="true">
    ...
    <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-5"><TabsList className="grid w-full grid-cols-4 md:w-[620px]"><TabsTrigger value="overview">Visão geral</TabsTrigger><TabsTrigger value="movements">Movimentações</TabsTrigger><TabsTrigger value="obligations">Títulos</TabsTrigger><TabsTrigger value="registrations">Cadastros</TabsTrigger></TabsList>
      ...
      <TabsContent value="obligations" className="space-y-5"><FinanceObligationsPanel scopeId={scopeId} canOperate={canOperate} categories={categories} payees={payees} costCenters={costCenters} onChanged={async () => { await refresh(scopeId, filters) }} /><FinanceRecurrencesPanel scopeId={scopeId} canOperate={canOperate} categories={categories} payees={payees} costCenters={costCenters} onChanged={async () => { await refresh(scopeId, filters) }} /></TabsContent>
