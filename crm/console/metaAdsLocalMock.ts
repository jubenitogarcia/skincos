      ...
      ads: [
        {
          ...
          creative: {
            ...
            asset_feed_spec: {
              ...
              images: [
                {
                  hash: 'mock_skin_oil_square',
                  url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=720&h=720&q=80',
                  width: 720,
                  height: 720,
                },
                {
                  hash: 'mock_skin_oil_vertical',
                  url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=720&h=960&q=80',
                  width: 720,
                  height: 960,
                },
                {
                  hash: 'mock_skin_oil_wide',
                  url: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=1000&h=500&q=80',
                  width: 1000,
                  height: 500,
                },
              ],
        ...
        },
        {
          ...
          creative: {
            ...
            asset_feed_spec: {
              ...
              images: [
                {
                  hash: 'mock_whatsapp_creative_square',
                  url: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=720&h=720&q=80',
                  width: 720,
                  height: 720,
                },
                {
                  hash: 'mock_whatsapp_creative_vertical',
                  url: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=720&h=960&q=80',
                  width: 720,
                  height: 960,
                },
              ],
