...
const dashboard: InfluencerCreatorDashboard = {
  ...
  history: [{ observedAt: '2026-08-10T12:00:00.000Z', followers: metric(12000), following: metric(null, 'unavailable'), mediaCount: metric(40), engagementRate: metric(0.035, 'derived') }],
  media: [{ mediaKey: 'media-1', publishedAt: '2026-08-09T12:00:00.000Z', format: 'reel', likes: metric(350), comments: metric(12), views: metric(null, 'unavailable'), reach: metric(null, 'unavailable'), engagementRate: metric(0.029, 'derived'), outlier: metric(false, 'derived') }],
  analysis: { postingCadence: metric(3, 'derived'), medianLikes: metric(350, 'derived'), medianComments: metric(12, 'derived'), engagementRate: metric(0.035, 'derived'), medianViews: metric(null, 'unavailable'), growthVelocity: metric(345, 'derived'), growthAcceleration: metric(null, 'unavailable'), volatility: metric(0.08, 'derived'), outlierRatio: metric(0, 'derived'), warnings: ['Pouco histórico próprio para crescimento.'] },
