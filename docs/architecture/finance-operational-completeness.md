...
| Contas a pagar/receber e liquidação | Núcleo e UI operacional implementados localmente | migration `0011`, aba **Títulos** com criação, filtros, detalhe/auditoria, baixa parcial e cancelamento; liquidação continua ligada a lançamento confirmado, com idempotência e auditoria | calendário, aging, fluxo projetado e teste autenticado em staging da nova tela |
