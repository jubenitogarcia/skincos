...
Playwright projects are desktop 1440x900, notebook 1280x720, tablet 1024x768 and mobile 390x844. Use roles, labels and text locators; do not add position or class selectors. Update a visual baseline only after an intentional, reviewed synthetic-state change.
