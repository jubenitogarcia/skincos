...
- O Menu Iniciar também recebe atalhos diretos em `SKINCOS\CRM – Módulos\<papel>`.
...
O navegador só abre depois que o gate do módulo retorna `ok=true`. Insumos e Ponto usam Workers e persistência locais quando declarados; o adapter do CRM é isolado por runtime. Pages e Insumos compartilham apenas o registry Wrangler privado daquela instância.
