export type AtendimentoClinicaFilters = {
  unit: string
  from: string
  to: string
  procedure: string
...
export type AtendimentoClinicaForm = {
  id?: string
  unitSlug: string
  unitName?: string
  date: string
...
export const DEFAULT_ATENDIMENTO_FILTERS: AtendimentoClinicaFilters = {
  unit: 'all',
  from: '',
  to: '',
  procedure: 'all',
...
export const EMPTY_ATENDIMENTO_FORM: AtendimentoClinicaForm = {
...
export function calculateAtendimentoValue(input: Pick<AtendimentoClinicaForm, 'code' | 'quantity' | 'discount' | 'otherValue' | 'roundValue'>) {
...
export function buildAtendimentoQuery(filters: AtendimentoClinicaFilters, paging: { limit?: number; offset?: number } = {}) {
...
export function validateAtendimentoForm(form: AtendimentoClinicaForm, allowedCodes: string[]) {
