...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('instagram-module/logs/instagram.log'),
...
class InstagramModule:
    ...
    def __init__(self, config_path: str = "instagram-module/config/config.json"):
        """Initialize Instagram module with configuration"""
        self.config_path = config_path
        self.config = self._load_config()
        self.clients = {}  # Store multiple Instagram clients
        self.session_dir = Path("instagram-module/sessions")
        self.downloads_dir = Path("instagram-module/downloads")
        self.logs_dir = Path("instagram-module/logs")
