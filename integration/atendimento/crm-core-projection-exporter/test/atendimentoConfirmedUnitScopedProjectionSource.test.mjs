...
test('exports only Atendimento-owned lifecycle-proven membership without a global fallback or source PII', () => {
  ...
  assert.doesNotMatch(rowsSql, /(?:member|attendance_link|attendance)\.updated_at/i)
