...
function isOnboardingDependencyError(value) {
  ...
  return code === 'IDENTITY_PII_KEY_NOT_CONFIGURED'
    ...
    || /^(WORKFORCE_|SMTP_|EMAIL_|MODULE_|TIMEKEEPING_|RELEASE_AFFINITY_|RUNTIME_BINDINGS_|SERVICE_|DATABASE_UNAVAILABLE|ONBOARDING_MIGRATION_REQUIRED)/.test(code);
}
