...
export default {
    async fetch(request, env, ctx) {
        ...
        const d1 = {
            ...
            listInsumosByCodigos: ({ unidade, codigos }) => d1ListInsumosByCodigos({ env, unidades: UNIDADES, unidade, codigos }),
            createInsumo: ({ unidade, body, actor }) => d1CreateInsumo({ env, unidades: UNIDADES, unidade, body, actor }),
            updateInsumo: ({ registro, body }) => d1UpdateInsumo({ env, registro, body }),
            deleteInsumo: ({ registro }) => d1DeleteInsumo({ env, registro }),
            archiveInsumo: ({ registro }) => d1ArchiveInsumo({ env, registro }),
            ...
            listFornecedores: ({ unidade, actor, includeArchived }) => d1ListFornecedores({ env, unidade, actor, includeArchived }),
            createFornecedor: ({ unidade, actor, body }) => d1CreateFornecedor({ env, unidade, actor, body }),
            archiveFornecedor: ({ id, unidade, actor }) => d1ArchiveFornecedor({ env, id, unidade, actor }),
            listPedidosInternos: ({ unidade, actor, status }) => d1ListPedidosInternos({ env, unidade, actor, status }),
            getPedidoInterno: ({ id, unidade, actor }) => d1GetPedidoInterno({ env, id, unidade, actor }),
            createPedidoInterno: ({ unidade, actor, body }) => d1CreatePedidoInterno({ env, unidade, actor, body }),
            receberPedidoInterno: ({ id, unidade, actor, body }) => d1ReceberPedidoInterno({ env, id, unidade, actor, body }),
            cancelarPedidoInterno: ({ id, unidade, actor, justificativa }) => d1CancelarPedidoInterno({ env, id, unidade, actor, justificativa }),
            listPoliticasReposicao: ({ unidade, actor, includeInactive }) => d1ListPoliticasReposicao({ env, unidade, actor, includeInactive }),
            ...
            gerarSugestoesReposicao: ({ unidade, actor }) => d1GerarSugestoesReposicao({ env, unidade, actor }),
            dismissSugestaoReposicao: ({ id, unidade, actor, justificativa }) => d1DismissSugestaoReposicao({ env, id, unidade, actor, justificativa }),
