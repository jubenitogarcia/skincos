...
The closure contains only the WhatsApp HTTP adapters and their tests. It does
not contain Evolution source, another product's message metadata store, product
routes, systemd units, release scripts, or Platform/Ops coordination code.
