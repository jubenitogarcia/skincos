...
// server.js lives in: <repo>/modules/crm/api/server.js
// so repo root is 3 levels up from __dirname (<repo>/modules/crm/api -> <repo>).
...
function resolveCrmUiDir() {
    ...
    // Fallback for dev environments (Vite dev server uses modules/crm/web/ index.html).
