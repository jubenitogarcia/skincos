...
git config --global --add safe.directory /mnt/c/CodexShared/Projetos/skincos/orb/engine || true
...
echo "  bash /mnt/c/CodexShared/Projetos/skincos/orb/engine/scripts/validate-mini-pc-system-runtime.sh"
