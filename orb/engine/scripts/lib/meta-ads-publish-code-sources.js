...
// Every mutable Code node in the canonical Meta Ads Publish definition must
// have exactly one tracked source file. Keep this map shared by extraction and
// live preflight so a newly added node cannot silently bypass drift detection.
const CODE_SOURCES = Object.freeze({
  ...
  'Prepare CRM Offer Context Requests': 'prepare-crm-offer-context-requests.js',
