...
const EXPECTED_VERSION_ID = 'f6ee2951-0787-43ab-9916-2eaba2fe787f';
...
function backupWorkflow(workflow) {
  ...
  const backupPath = path.join(ROOT, 'workflows', `livia.before-parse-frame-analysis-no-lookups.${stamp}.json`);
