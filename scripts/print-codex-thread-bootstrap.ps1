...
$lines = @(
    ...
    "4. Depois de criar o worktree, valide a identidade com ``powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\validate-skincos-worktree.ps1 -ProjectRoot (Get-Location).Path -TaskSlug $TaskSlug -Mode edit``; trabalhe apenas nele e trate o clone compartilhado como somente leitura para contexto.",
