...
crm_local_wa_root_main() {
  ...
  export DEV_AUTH_ALLOWED_UNITS="${LOCAL_AUTH_ALLOWED_UNITS:-${DEV_AUTH_ALLOWED_UNITS:-}}"
  export DEV_AUTH_ALLOWED_MODULES="${LOCAL_AUTH_ALLOWED_MODULES:-${DEV_AUTH_ALLOWED_MODULES:-}}"
...
crm_local_wa_main() {
  ...
  exec sudo -n /usr/bin/env \
    ...
    DEV_AUTH_ALLOWED_UNITS="${DEV_AUTH_ALLOWED_UNITS:-${LOCAL_AUTH_ALLOWED_UNITS:-}}" \
    DEV_AUTH_ALLOWED_MODULES="${DEV_AUTH_ALLOWED_MODULES:-${LOCAL_AUTH_ALLOWED_MODULES:-}}" \
    UNIFIED_TEAM_ENABLED="${UNIFIED_TEAM_ENABLED:-}" \
    LOCAL_CRM_TEAM_SEED="${LOCAL_CRM_TEAM_SEED:-}" \
    LOCAL_CRM_SEED_FILE="${LOCAL_CRM_SEED_FILE:-}" \
    LOCAL_CRM_STORE_FILE="${LOCAL_CRM_STORE_FILE:-}" \
