...
function Invoke-ShortcutActionInternal {
    ...
    switch ($SelectedAction) {
        ...
        "CrmAtendimento" {
            ...
            Invoke-ShortcutWsl -WorkingProjectRoot $crmAtendimentoLaunch.SourceRoot -Command ("CRM_TARGET_COMMIT={0} CRM_SOURCE_FINGERPRINT={1} CRM_PID_FILE={2} CRM_LOG_FILE={3} bash ./scripts/run-local-atendimento.sh" -f `
