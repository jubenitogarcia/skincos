...
# ProtectSystem=strict requires the writable path to exist before systemd
# creates its mount namespace. The custody file and its secret remain
# workflow-owned and are written later by the fixed helper.
