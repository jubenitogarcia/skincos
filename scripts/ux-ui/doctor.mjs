...
const checks = [
  ...
  ['website Playwright', path.join(root, 'website/node_modules/playwright/package.json')],
  ['website axe', path.join(root, 'website/node_modules/@axe-core/playwright/package.json')],
