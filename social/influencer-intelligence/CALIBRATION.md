...
| partial-and-missing-metrics | Missing views/engagement remain unavailable and reduce coverage. | No-views score coverage `83.9`, views/follower metric coverage `0`; matching with-views control reaches `1`; incomplete-series coverage `52`; unavailable values remained `null`. | PASS |
