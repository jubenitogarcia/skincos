...
export const IMPLEMENTATION_PLAN = deepFreeze([
  ...
  { id: 'M13', title: 'Optional provider gap analysis', status: 'source implemented; measured gap matrix/ADR; no external provider integrated', acceptance: ['measured gap report', 'cost/risk/privacy review', 'new provider only after explicit configuration, allowlisting, and approval'] },
]);
