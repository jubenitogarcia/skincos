...
export const IMPLEMENTATION_PLAN = deepFreeze([
  ...
  { id: 'M3', title: 'Append-only snapshots, retention, and Orb job contract', status: 'data model v1 in this PR; Orb scheduling pending', acceptance: ['new additive tables', 'immutable evidence lifecycle', 'dry-run/shadow scheduling', 'resume/recovery without live workflow import'] },
