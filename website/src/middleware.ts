...
function isPublicAsset(pathname: string): boolean {
    return (
        ...
        pathname.startsWith("/production-snapshot/") ||
...
export function middleware(req: NextRequest) {
    ...
    if (!isPublicAsset(url.pathname)) {
        ...
        const legacyRedirects: Record<string, string> = {
            ...
            "/patricialeaoferras": "https://api.whatsapp.com/send?phone=5551980882293&text=Ganhei+um+%2Adesconto+exclusivo%2A+da+%40patricialeaoferras+para+o+meu+momento+de+%2Aauto-cuidado+e+bem-estar%2A+na+Espa%C3%A7o+Facial.+Quero+saber+mais%21+%F0%9F%92%A5",
