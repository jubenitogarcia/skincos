...
test("the finale exposes a non-cancellable five-second merge countdown", async () => {
    ...
    assert.match(experience, /A carta especial aparece em cinco segundos/);
    ...
    assert.match(experience, /className=\{showRevealAction \? styles\.specialCardRevealContent : undefined\}/);
