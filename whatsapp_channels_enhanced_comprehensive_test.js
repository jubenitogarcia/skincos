...
class EnhancedLogger {
    ...
    async saveScreenshot(channel, state, additionalInfo = {}) {
        try {
            await fs.mkdir(`${CONFIG.EVIDENCE_DIR}/screenshots`, { recursive: true });
...
async function generateComprehensiveReport() {
    ...
    const detailedReportPath = `enhanced_whatsapp_channels_detailed_report_${Date.now()}.json`;
...
`;
    ...
    const summaryPath = `enhanced_whatsapp_channels_summary_${Date.now()}.md`;
